...
CREATE TABLE IF NOT EXISTS accounts (wallet TEXT PRIMARY KEY, display_name TEXT, device_id TEXT, points_balance INTEGER NOT NULL DEFAULT 0, streak INTEGER NOT NULL DEFAULT 0, last_quest_day TEXT, step_goal INTEGER NOT NULL DEFAULT 6000 CHECK (step_goal BETWEEN 3000 AND 12000));
